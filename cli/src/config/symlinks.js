...
module.exports = {
  ...
  "apps/nvim/lua/mikemimik/mappings.lua":
    ".config/nvim/lua/mikemimik/mappings.lua",
  "apps/nvim/lua/mikemimik/plugins.lua":
    ".config/nvim/lua/mikemimik/plugins.lua",
  // "apps/nvim/lua/mikemimik/treesitter.lua":
  //   ".config/nvim/lua/mikemimik/treesitter.lua",

  "apps/nvim/after/plugin/bufferline.rc.lua":
    ".config/nvim/after/plugin/bufferline.rc.lua",
  "apps/nvim/after/plugin/close-buffer.rc.lua":
    ".config/nvim/after/plugin/close-buffer.rc.lua",
  // 'apps/nvim/after/plugin/cmp.rc.lua': '.config/nvim/after/plugin/cmp.rc.lua',
  "apps/nvim/after/plugin/lsp.rc.lua": ".config/nvim/after/plugin/lsp.rc.lua",
  "apps/nvim/after/plugin/colors.rc.lua":
    ".config/nvim/after/plugin/colors.rc.lua",
  "apps/nvim/after/plugin/glow.rc.lua": ".config/nvim/after/plugin/glow.rc.lua",
  "apps/nvim/after/plugin/transparent.rc.lua":
    ".config/nvim/after/plugin/transparent.rc.lua",
  "apps/nvim/after/plugin/indentline.rc.lua":
    ".config/nvim/after/plugin/indentline.rc.lua",
  // "apps/nvim/after/plugin/lspkind.rc.lua":
  //   ".config/nvim/after/plugin/lspkind.rc.lua",
  "apps/nvim/after/plugin/lualine.rc.lua":
    ".config/nvim/after/plugin/lualine.rc.lua",
  "apps/nvim/after/plugin/prettier.rc.lua":
    ".config/nvim/after/plugin/prettier.rc.lua",
  "apps/nvim/after/plugin/telescope.rc.lua":
    ".config/nvim/after/plugin/telescope.rc.lua",
  "apps/nvim/after/plugin/treesitter.rc.lua":
    ".config/nvim/after/plugin/treesitter.rc.lua",
  "apps/nvim/after/plugin/web-devicons.rc.lua":
    ".config/nvim/after/plugin/web-devicons.rc.lua",
  ...
  "apps/karabiner/assets/complex_modifications/local.json":
    ".config/karabiner/assets/complex_modifications/local.json",
  "apps/karabiner/assets/complex_modifications/q8.json":
    ".config/karabiner/assets/complex_modifications/q8.json",
  "apps/karabiner/assets/complex_modifications/k11.json":
    ".config/karabiner/assets/complex_modifications/k11.json",
  "apps/karabiner/assets/complex_modifications/okta-machine.json":
    ".config/karabiner/assets/complex_modifications/okta-machine.json",
  "apps/karabiner/assets/complex_modifications/personal-machine.json":
    ".config/karabiner/assets/complex_modifications/personal-machine.json",
